...
import { CustomComponent, BasicComponent, Component } from '../internal';

export const isPrimitiveComponent = (
  component: Component,
): component is BasicComponent => component instanceof BasicComponent;
