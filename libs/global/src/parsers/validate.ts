...
const parseToClass = <Subject = Object, Target = Object>(data: Subject, targetClass: ClassType<Target>) => {
  return isObject(data) ? of(o.some(plainToClass(targetClass, data))) : of(o.none);
}

export const parseAndValidate = <Subject = Object, Target = Object>(
  data: Subject,
