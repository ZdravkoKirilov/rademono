...
export const createComponent = (
  ...
  if (isCustomType(element.type)) {
    ...
    const rendered = callWithErrorPropagation<RzRenderedNode>(parent, () =>
      component.render(),
    );
    ...
    if (isRzElement(rendered)) {
      component._children = [
        createComponent(rendered, factory, meta, component),
      ];
    }
    ...
    throw new Error(
      'Invalid render result from component. ' + component + ': ' + rendered,
    );
  }
